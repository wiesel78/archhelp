...
tags = {
     names = { "main", "www", "term", 4, "im" --, 6, 7, 8, 9
		},
     layout = { layouts[1], layouts[3], layouts[1], layouts[2], layouts[3],
...
vicious.register(batterywidget, vicious.widgets.bat, battery.batclosure(), 31, "BAT0")
